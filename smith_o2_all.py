...
if not database_file:
    raise ValueError("Database file not provided. Use the -db argument to specify the file.")
...
# python smith_o2_all.py -db /Users/anaselyoussef/Desktop/algo/data/Align/small_db
